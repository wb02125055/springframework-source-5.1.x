...
public abstract class JdbcAccessor implements InitializingBean {
	...
	/**
	 * Specify(指定) the database product name for the DataSource that this accessor uses.
	...
	public void afterPropertiesSet() {
		...
		/**
		 * 默认lazyInit为true，此处不会执行
		 */
		if (!isLazyInit()) {
			// 异常转化器，将SQL中的异常信息转化为SQL中的一些错误码.
